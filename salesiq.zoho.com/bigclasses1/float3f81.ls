...
_ZLDSCREENNAME="bigclasses1"; //No I18N
_ZLDEMBEDNAME="bigclasses";  //No I18N
...
_ZSIQ.isautopickenabled = true; //No I18N
...
function ZloadFiles()
{
  ...
  ocss.rel ="stylesheet";
  ocss.href = "https://css.zohostatic.com/salesiq/Dec_04_2020_6_https/styles/floatsupportbtn.css";  
  ...
  try
  {
		...
		if(ie && document.compatMode!="CSS1Compat")
		{
				var ocss = document.createElement("link");
				ocss.rel ="stylesheet";
				ocss.href = "https://css.zohostatic.com/salesiq/Dec_04_2020_6_https/styles/floatiebtnfix.css";  
				headArr[0].appendChild(ocss);
		}
  ...
  if(false)
  {
     	...
     	oscript2.src="https://salesiq.zohopublic.com/js/embed/jsapi.js";   //No I18N
     	headArr[0].appendChild(oscript2); //No I18N
     	
     	var oscript3=document.createElement("script"); //No I18N
     	oscript3.src="https://salesiq.zohopublic.com/js/embed/analytics.js";   //No I18N
  ...
  oscript.src="https://js.zohostatic.com/salesiq/Dec_04_2020_6_https/js/track.js";  //No I18N
  headArr[0].appendChild(oscript);//No I18N
}
...
function ZaddEvent()
{
  	...
  	var iframeurl = "https://salesiq.zohopublic.com/bigclasses1/chatwindow.ls?";  	
    var _zldcpage = "http://bigclasses.com/english/"; 
  ...
  _ZSIQ.initSIQAPI = _ZSIQ.initSIQAPI || function()   //No I18N
  {
    ...
    var floatcookie = readCookie('zld211246000000002043float');//No I18N
	...
	lsid:'211246000000002043' // NO I18N
	};
	try
	{
  ...
  _ZSIQ.initFloat = function()//No I18N
  {
	Float.newembed = true;//No I18N
		...
		Float.lsobject["screenname"]="bigclasses1" ;
		...
		Float.lsobject.currdomain = "bigclasses.com";
		Float.lsobject["float_fkey"]="0_211246000000002043"; 
		Float.lsobject["css_fkey"]=""; 
